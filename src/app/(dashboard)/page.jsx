...
export default function DashboardPage() {
  const { projects, ipcs, teams, materials } = useStore();
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl p-6 shadow-sm border border-slate-200">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link href="/projects" className="text-[11px] font-bold text-slate-900 hover:text-black flex items-center gap-1 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-200 transition-colors">
                  ...
                  {filteredProjects.slice(0, 6).map((proj) => (
                    <tr key={proj.id} className="hover:bg-slate-50/80 transition-colors group">
                      <td className="py-4 px-2 font-bold text-slate-900">
                        <Link href={`/projects/${proj.id}`} className="hover:text-black transition-colors">
                          {proj.name}
                        </Link>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <Link href="/ipc" className="text-[11px] font-bold text-slate-900 hover:text-black flex items-center gap-1 bg-slate-50 px-3 py-1.5 rounded-lg border border-slate-200 transition-colors">
                  Chi tiết
                </Link>
              </div>
