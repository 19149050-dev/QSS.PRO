...
export default function EditProjectModal({ project, isOpen, onClose }) {
  ...
  useEffect(() => {
    if (project) {
      setFormData({
        name: project.name || '',
        projectType: project.projectType || 'Sơn nước',
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-xs flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-3xl shadow-2xl border border-gray-100 animate-in fade-in zoom-in duration-200">
        <div className="p-6 rounded-t-2xl bg-gradient-to-r from-indigo-600 to-purple-600 text-white flex items-center justify-between">
