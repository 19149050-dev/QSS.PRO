    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-xs flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-xl shadow-2xl border border-gray-100 overflow-hidden animate-in fade-in zoom-in duration-200">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block font-semibold text-gray-700 mb-1">CĐT / Tổng Thầu</label>
              <input
                type="text"
                value={formData.subContractorInfo}
                onChange={(e) => setFormData({ ...formData, subContractorInfo: e.target.value })}
                className="w-full px-3 py-2 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500"
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            <div>
              <label className="block font-semibold text-gray-700 mb-1">Phụ lục (VNĐ)</label>
              <input
                type="number"
